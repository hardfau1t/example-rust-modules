...
int snull_open(struct net_device *dev)
{
	 ...
	 */
	memcpy((void*)dev->dev_addr, "\0SNUL0", ETH_ALEN);
	if (dev == snull_devs[1])
		*(unsigned char*)&dev->dev_addr[ETH_ALEN-1] = dev->dev_addr[ETH_ALEN-1] + 1; /* \0SNUL1 */
...
void snull_init(struct net_device *dev)
{
	...
	dev->watchdog_timeo = SNULL_TIMEOUT;
