...
#define CPSW_DEBUG                                                         \
    (NETIF_MSG_HW | NETIF_MSG_WOL | NETIF_MSG_DRV | NETIF_MSG_LINK |       \
     NETIF_MSG_IFUP | NETIF_MSG_INTR | NETIF_MSG_PROBE | NETIF_MSG_TIMER | \
     NETIF_MSG_IFDOWN | NETIF_MSG_RX_ERR | NETIF_MSG_TX_ERR |              \
     NETIF_MSG_TX_DONE | NETIF_MSG_PKTDATA | NETIF_MSG_TX_QUEUED |         \
     NETIF_MSG_RX_STATUS)
...
#define CPSW_MAX_PACKET_SIZE \
    (VLAN_ETH_FRAME_LEN + ETH_FCS_LEN + CPSW_RX_VLAN_ENCAP_HDR_SIZE)
...
#define CTRL_V2_TS_BITS                                                     \
    (TS_320 | TS_319 | TS_132 | TS_131 | TS_130 | TS_129 | TS_TTL_NONZERO | \
     TS_ANNEX_D_EN | TS_LTYPE1_EN | VLAN_LTYPE1_EN)
...
#define CTRL_V3_TS_BITS                                              \
    (TS_107 | TS_320 | TS_319 | TS_132 | TS_131 | TS_130 | TS_129 |  \
     TS_TTL_NONZERO | TS_ANNEX_F_EN | TS_ANNEX_D_EN | TS_LTYPE1_EN | \
     VLAN_LTYPE1_EN)
