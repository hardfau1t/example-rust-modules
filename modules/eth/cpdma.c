...
EXPORT_SYMBOL(cpdma_chan_int_ctrl);
EXPORT_SYMBOL(cpdma_chan_stop);
EXPORT_SYMBOL(cpdma_chan_start);
EXPORT_SYMBOL(cpdma_chan_process);
EXPORT_SYMBOL(cpdma_chan_submit_mapped);
EXPORT_SYMBOL(cpdma_chan_submit);
EXPORT_SYMBOL(cpdma_chan_idle_submit_mapped);
EXPORT_SYMBOL(cpdma_chan_idle_submit);
EXPORT_SYMBOL(cpdma_chan_get_stats);
EXPORT_SYMBOL(cpdma_chan_destroy);
EXPORT_SYMBOL(cpdma_chan_get_rx_buf_num);
EXPORT_SYMBOL(cpdma_chan_get_rate);
EXPORT_SYMBOL(cpdma_chan_set_rate);
EXPORT_SYMBOL(cpdma_chan_get_min_rate);
EXPORT_SYMBOL(cpdma_chan_set_weight);
EXPORT_SYMBOL(cpdma_ctlr_int_ctrl);
EXPORT_SYMBOL(cpdma_ctlr_eoi);
EXPORT_SYMBOL(cpdma_ctrl_rxchs_state);
EXPORT_SYMBOL(cpdma_ctrl_txchs_state);
